  ...
  return (
    <main className="min-h-screen bg-black text-white flex flex-col overflow-x-hidden">
      ...
      <section className="flex flex-col items-center justify-center text-center px-6 sm:px-8 lg:px-12 pt-32 pb-20 flex-1">
        ...
        <p className="text-gray-300 text-base sm:text-lg md:text-xl leading-8 max-w-2xl">
          Find nearby restaurants, explore locations, and track places around your area easily.
        </p>

        <Link href="/restaurants">
          <button className="mt-8 bg-orange-500 hover:bg-orange-600 px-8 py-4 rounded-xl text-base sm:text-lg font-semibold transition duration-300">
            Explore Restaurants
          </button>
        </Link>
      </section>
...
<footer className="bg-black">
        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 py-12">
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <p className="text-gray-400 leading-7 text-base max-w-2xl mb-6">
